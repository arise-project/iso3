...
namespace AstTests
{
    public class App : IApp
    {
        ...
        private AstConnector connector = new AstConnector();

        private ISyntaxNodesToClasses _syntaxNodesToClasse;
        private ISyntaxNodesToCollections _syntaxNodesToCollections;
